...
public class UpdateFoodInfoPanel extends javax.swing.JFrame {
     ...
     */
    public UpdateFoodInfoPanel(String key) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UpdateFoodInfoPanel.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new UpdateFoodInfoPanel(key).setVisible(true);
            }
        });
    }
